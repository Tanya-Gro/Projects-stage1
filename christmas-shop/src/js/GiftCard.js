  ...
  generateGift() {
    ...
    if (this.category) {
      ...
      if (this.category === "For Health") {
        path += 'gift-for-health.png';
        alt = 'gift for health';
        h5class = 'h5--green';
      }
      else if (this.category === "For Harmony") {
        path += 'gift-for-harmony.png';
        alt = 'gift for harmony';
        h5class = 'h5--pink';
      }
      else {
        path += 'gift-for-work.png';
        alt = 'gift for work';
        h5class = 'h5--blue';
      }
      template += `<img src="${path}" alt="${alt}" class="gift__image"><div class="gift__description"> <h5 class="${h5class}">${this.category}</h5>`;
